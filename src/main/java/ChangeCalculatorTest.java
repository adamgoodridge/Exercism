...
public class ChangeCalculatorTest {
    ...
    public void testADAMTEST() {
        ChangeCalculator changeCalculator = new ChangeCalculator(asList(1,2,3,4));

        assertEquals(
                asList(3,3),
                changeCalculator.computeMostEfficientChange(6));
    }
    @Test
    ...
    public void testAnotherPossibleChangeWithoutUnitCoinAvailable() {
        ChangeCalculator changeCalculator = new ChangeCalculator(asList(1,4, 5));
